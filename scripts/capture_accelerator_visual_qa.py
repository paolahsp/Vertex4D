...
STUDENT_PAGES = [
    {
        "file": "01-student-decision-case-desktop.png",
        "title": "Student workspace: Decision Case",
        "url": "/dashboard/lab/start-golden-path",
        "description": "Student enters the Golden Path and sees the baseline job before any downstream artifact.",
        "expected": ["Open a Decision Case", "Locked Baseline + ProjectRecord", "Next action"],
    },
    {
        "file": "02-student-alex-desktop.png",
        "title": "Student workspace: Alex",
        "url": "/dashboard/lab/alex",
        "description": "Student frames the problem and sees why the ProblemFrame matters downstream.",
        "expected": ["ProblemFrame", "Why it matters", "Where this goes"],
    },
    {
        "file": "03-student-synapmap-desktop.png",
        "title": "Student workspace: SynapMap",
        "url": "/dashboard/lab/synapmap",
        "description": "Student maps users, payers, approvers, blockers and dependencies.",
        "expected": ["SystemMap", "payer", "approver"],
    },
    {
        "file": "04-student-approval-gate-desktop.png",
        "title": "Student workspace: Approval Gate",
        "url": "/dashboard/lab/assumption-approval",
        "description": "Student/facilitator sees which assumptions can propagate into D-Predict or Billie.",
        "expected": ["Approved assumption register", "Hard gate", "downstream"],
    },
    {
        "file": "05-student-d-predict-desktop.png",
        "title": "Student workspace: D-Predict + QBI lite",
        "url": "/dashboard/lab/d-predict",
        "description": "Student creates a bounded behavior hypothesis and sees QBI lite as a reading, not a prediction.",
        "expected": ["PredictiveHypothesis", "QBI lite", "not proof"],
    },
    {
        "file": "06-student-billie-desktop.png",
        "title": "Student workspace: Billie",
        "url": "/dashboard/lab/billie",
        "description": "Student tests economic assumptions and pricing coherence.",
        "expected": ["FinancialScenario", "price", "cost"],
    },
    {
        "file": "07-student-decision-record-desktop.png",
        "title": "Student workspace: DecisionRecord",
        "url": "/dashboard/lab/decision-record",
        "description": "Student converts the reviewed chain into a bounded next commitment.",
        "expected": ["DecisionRecord", "final decision", "provenance"],
    },
]
...
FACILITATOR_PAGES = [
    ...
    },
    {
        ...
        "expected": ["Outcome Report", "DecisionRecord", "intervention"],
    },
    {
        "file": "11-decision-memo-desktop.png",
        "title": "Decision Memo",
        "url": "/dashboard/lab/decision-memo?run_id=run_demo_economics_changed",
        "description": "Buyer sees the case-level artifact that connects baseline, evidence and final decision.",
        "expected": ["Decision Memo", "run_demo_economics_changed", "price"],
    },
]
...
MOBILE_PAGES = [
    {
        "file": "12-student-decision-case-mobile.png",
        "title": "Mobile student: Decision Case",
        "url": "/dashboard/lab/start-golden-path",
        "description": "Checks the first student step at buyer/mobile width.",
        "expected": ["Decision Case", "Next action"],
    },
    {
        "file": "13-student-d-predict-mobile.png",
        "title": "Mobile student: D-Predict + QBI lite",
        "url": "/dashboard/lab/d-predict",
    ...
    },
    {
        ...
        "expected": ["Outcome Report", "DecisionRecord"],
    },
]
