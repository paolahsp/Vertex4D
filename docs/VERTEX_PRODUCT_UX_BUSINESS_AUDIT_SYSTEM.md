...
What do I do now?
Why does it matter?
What decision skill am I using?
...
| Rubric baseline/post | Facilitator / buyer | Medir movimiento observado | Quality scores | 1 - Implemented | Differentiator if human-reviewed | P1 |
...
| Trust Pack | Buyer / procurement | Reducir riesgo de compra piloto | Procurement docs | 1 - Implemented as checklist | Table stakes for paid pilot | P0 before sale |
...
1. Agregar un `Next Best Action` persistente por rol.
...
Elegir 3 paginas maximo y completar el template.
...
| Page | User | Job | Artifact | Aha | Contradiction check | Evidence level | Commercial role | Priority | Next change | Evidence needed |
|---|---|---|---|---|---|---|---|---|---|---|
...
2. La pagina revela algo sobre la decision.
...
7. El claim comercial queda dentro de la evidencia disponible.
